...
export function Composer({ open, value, listening, disabled, onChange, onSend, onToggleListen }: Props) {
	...
	return (
		...
		>
			...
			/>
			<Button type="submit" size="icon" tabIndex={open ? 0 : -1} disabled={disabled || !value.trim()} aria-label="Send">
