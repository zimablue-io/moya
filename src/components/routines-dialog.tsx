...
import { AUTOMATION_PRESETS, formatTrigger, type AutomationDraft } from "@/lib/automations";
    ...
    <Dialog open={dialog === "routines"} onOpenChange={(o) => openDialog(o ? "routines" : null)}>
      <DialogContent className="grid-rows-[auto_1fr_auto] sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Things Moya does without being asked. They run on this device only.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="flex flex-col gap-4 py-2">
              ...
              <ul className="flex flex-col gap-2">
                {AUTOMATION_PRESETS.map((p) => (
                  <li
                    key={p.name}
                    className="flex items-start justify-between gap-3 rounded-xl bg-surface-2 p-3"
                  >
                    <div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Badge variant={a.enabled ? "ok" : "default"}>
                    ...
                    <div className="flex shrink-0 items-center gap-1">
                      <Switch
                        checked={a.enabled}
                        onCheckedChange={(v) => updateAutomation(a.id, { enabled: v })}
                      />
                      <Button
                        size="icon"
                        variant="ghost"
        ...
        {openForm ? (
          ...
          >
            ...
            <Textarea
              ...
              placeholder="What should Moya do?"
            />
