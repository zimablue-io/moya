...
- Providers: Local (Kokoro speaker + Base URL), Grok / OpenAI (speaker + key), System (this device’s built-in voices + rate + pitch). System is not a second block next to Local.
